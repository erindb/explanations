...
rep2 = cfs %>% filter(story=='story2') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0.13813741920038305, 0, 0))
graph(rep2)
```
...
rep4 = cfs %>% filter(story=='story4') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0.6341154090044389, 0.6341154090044389, 1, 1))
graph(rep4)
```
...
rep5 = cfs %>% filter(story=='story5') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0, 0.2609016999260903, 0, 0))
graph(rep5)
```
...
rep6 = cfs %>% filter(story=='story6') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0.7297090352220519, 1, 0.4229999999999996))
graph(rep6)
```
