...
cfs %>% filter(story=='story1') %>%
  ...
  as.data.frame %>% mutate(model_response=c(0, 0.5499999999999999)) %>% graph(.)
```
...
cfs %>% filter(story=='story2') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0.13253012048192778, 0, 0)) %>% graph(.)
```
...
cfs %>% filter(story=='story3a' | story=='story3b') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0, 0, 0.5499999999999999, 0.5499999999999999, 0.5499999999999999)) %>% graph(.)
```
...
cfs %>% filter(story=='story4') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0.6451612903225805, 0.6451612903225805, 1, 1)) %>% graph(.)
```
...
cfs %>% filter(story=='story5') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0, 0.2592592592592591, 0, 0)) %>% graph(.)
```
...
cfs %>% filter(story=='story6') %>%
  ...
  select(story, labN.before.exclusion, labN, turkN.before.exclusion,turkN,
         condition, variable, data_response, data_sd, model_response,model_sd) %>%
  as.data.frame %>%
  mutate(model_response = c(0.7307692307692304, 1, 0.4500000000000002)) %>% graph(.)
```
